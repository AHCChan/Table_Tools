...
USAGE:
    ...
    python27 Table_to_Table.py <input_path> <{input_format}> <output_path>
...
EXAMPLES:
    ...
    python27 Table_to_Table.py Test_Data_1.tsv tsv Test_Output.csv -f csv 2 3 4
            5 col5=Desert "col3>1.8"

    python27 Table_to_Table.py Test_Data_5__Headers_Comments.tsv tsv
            Test_Output.csv -f csv 2 3 4 5 col5=Desert "col3>1.8" -h skip C # -h
            keep N 1 -h rearrange N 1

    python27 Table_to_Table.py Test_Data_1.tsv tsv Test_Output.csv -f csv 1 2 3
            0 4
...
STR__t2t_begin = "\nRunning Table_To_Table..."

STR__t2t_complete = "\nTable_To_Table successfully finished."
...
def Strip_Non_Inputs(list1):
    ...
    """
    if "Table_to_Table.py" in list1[0]: return list1[1:]
    return list1[2:]
